...
export const ProfileIngestion: React.FC = () => {
    ...
    return (
        <div className="flex h-screen w-full bg-background-dark text-white font-display">
            ...
            <div className="flex h-full w-[260px] flex-col justify-between border-r border-border-dark bg-surface-dark hidden md:flex z-20">
                 <div className="flex flex-col gap-6 p-4">
                    ...
                    <nav className="flex flex-col gap-2">
                        ...
                        <a className={`flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-colors ${step >= 1 ? 'bg-primary/10 text-primary' : 'text-text-secondary'}`} href="#">
                        ...
                        <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-secondary hover:text-white transition-colors" href="#">
                            ...
                            <span className="text-sm">{t("admin.link.catalog")}</span>
                        </a>
                        <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-secondary hover:text-white transition-colors" href="#">
